...
function togglePanel() {
  ...
  if (panel) {
    ...
    panel.id = id;
    panel.style = "position: fixed; z-index: 1000; top: 0; right: 0; width: 250px; height: 100vh; overflow-y: auto; background-color: white; box-shadow: 2px 0 5px rgba(0,0,0,0.5);";
